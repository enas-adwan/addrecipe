...
String rating=cursor4.getString(0);
                ...
                records.add(record);
                vivsadapter1 = new Vivsadapter(MainActivity.this,records);
                ...
                listVieww.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent i=new Intent(MainActivity.this,Showonesqliteoffline.class);
                ...
                records= new ArrayList<Record>();
                    ...
                    try {
                      ...
                      //  Toast.makeText(getApplicationContext(), "Hello", Toast.LENGTH_SHORT).show();
                        ...
                        vivsadapter = new Vivsadapter(MainActivity.this,records);
