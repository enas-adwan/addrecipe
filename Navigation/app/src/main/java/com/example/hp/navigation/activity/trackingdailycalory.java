...
public class trackingdailycalory extends BaseActivity  {
    ...
    public ImageButton Getall;
    public ImageButton Getall1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   setSupportActionBar(toolbar);
        ...
        textcalory = (TextView) findViewById(R.id.textc);
...
Double b=Double.valueOf(bmr);
                ...
                Toast.makeText(getApplicationContext(), bmr1  , Toast.LENGTH_LONG).show();
                Text.setText(bmr1);
                textR.setText(bmr1);
        ...
        sqLiteDatabase = userDbHelper.getReadableDatabase();
        cursor = userDbHelper.getinformationtracking(sqLiteDatabase);
        listDataAdpter = new ListDataAdptertrack(getApplicationContext(), R.layout.row_layout);
...
String remain=re.toString();
        ...
        final DBManager myDb = new DBManager(trackingdailycalory.this);
        autoCom.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                try {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(trackingdailycalory.this,
        ...
        autoCom1 = (AutoCompleteTextView) findViewById(R.id.auto1);
        ...
        autoCom1.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                try {
                    ...
                    ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(trackingdailycalory.this,
        ...
        Getall1 = (ImageButton) findViewById(R.id.getall2);
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        ProgressDialog pdLoading = new ProgressDialog(trackingdailycalory.this);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("no rows")) {
                ...
                try {
                    ...
                    Toast.makeText(trackingdailycalory.this, strint, Toast.LENGTH_LONG).show();
                } catch (JSONException e) {
                    // You to understand what actually error is and handle it appropriately
                    Toast.makeText(trackingdailycalory.this, e.toString(), Toast.LENGTH_LONG).show();
                    Toast.makeText(trackingdailycalory.this, result.toString(), Toast.LENGTH_LONG).show();
                }
