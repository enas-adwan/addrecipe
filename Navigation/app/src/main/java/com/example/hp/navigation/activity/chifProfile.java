...
public class chifProfile extends BaseActivity {
    CallbackManager callbackManager;TextView name;
    TextView gender;TextView phone;TextView email;
    TextView location;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        SharedPreferences chif = getApplicationContext().getSharedPreferences("MyPref", MODE_PRIVATE);
        String chif_type=chif.getString("chif_type","");
        String chif_id=chif.getString("chif_id","");
        ...
        String type = pref.getString("chif_type", "nothing");
        Log.d("chid id ",chif_id);
        Log.d("chif_type",chif_type);
        if(type.equals(face)) {
            GetDataJSON g = new GetDataJSON();
            g.execute(chif_type,chif_id);
        }
    ...
    public class GetDataJSON extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try
            { //  String chif_type  = params[0];
                String chif_id  = params[1];
                ...
                String post_data = URLEncoder.encode("id","UTF-8")+"="+URLEncoder.encode(chif_id,"UTF-8");
        ...
        protected void onPostExecute(String result)
        {
            ...
            try {
                ...
                String id=pref.getString("chif_id","");
        ...
        protected String doInBackground(String... params) {
            ...
            try {
               // String chif_type  = params[0];
                ...
                OutputStream outputStream = httpURLConnection.getOutputStream();
                BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(outputStream, "UTF-8"));
                String post_data = URLEncoder.encode("user","UTF-8")+"="+URLEncoder.encode(chif_id,"UTF-8");
                bufferedWriter.write(post_data);
                bufferedWriter.flush();
                bufferedWriter.close();
                outputStream.close();
