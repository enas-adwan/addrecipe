...
public class ShowChifRecipe extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isOnline())
        {
            ...
            String user=type_user.getString("chif_type","");

            Log.d("show chif recipe ",user);
            String face="face";
            String app="app";
            if(user.equals(app))
            {   Log.d("type chif app",app);
    ...
    class showapprecipe extends AsyncTask<String, Void, String> {
       ...
       // String chif_id=chif.getString("chif_id","");
        String user=pref.getString("chif_id","");
        @Override
        ...
        public void onPostExecute(String s) {
            ...
            try {
                ...
                Vivsadapter adapter = new Vivsadapter(ShowChifRecipe.this,records);
                mRecyclerView = (RecyclerView) findViewById(R.id.masonry_grid);
    ...
    class showfacerecipe extends AsyncTask<String, Void, String> {
        ...
        ArrayList<Record> records;
        SharedPreferences pref = getApplicationContext().getSharedPreferences("MyPref", MODE_PRIVATE);
        String face_id=pref.getString("chif_id","");
        String json;
        String rating="";
        public String image = "";
        ...
        public void onPreExecute() {
            //   new  as.execute();
            super.onPreExecute();
            Log.d("show chif reciperesult ","start");
        }
        @Override
        public void onPostExecute(String s) {
            super.onPostExecute(s);
            Log.d("show chif reciperesult ",s);
            records= new ArrayList<Record>();
            try {
                JSONObject jObj = new JSONObject(s);
                String j = jObj.toString();
