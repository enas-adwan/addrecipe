...
/**
 * Created by eodwan on 10‏/11‏/2016.
 */
public class ListDataAdptersearch extends ArrayAdapter {

        List list = new ArrayList();
        TextView Text;
        public static ListView listView;

        public ListDataAdptersearch(Context context, int resource) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            // ViewHolder holder;
            listView = (ListView) searchfilter.listV;
            ...
            layoutHandler.deleteBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    userDbHelper.deletesearch(sqLiteDatabase, i);

                    notifyDataSetChanged();



                    searchfilter.setListViewHeightBasedOnItems(listView);
            ...
            if (layoutHandler != null) {
                ...
                userDbHelper2.istabledescexistsearch(sqLiteDatabase);
